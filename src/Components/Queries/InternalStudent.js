...
const InternalStudent = () => {
  ...
  return (
    <main className="internal">
      <h2 className="mb-2 mt-3 whitespace-break-spaces font-mono text-4xl font-bold text-violet-950 underline decoration-inherit decoration-2 underline-offset-4 dark:mt-0 dark:text-slate-200 md:text-6xl">
        Internal Mark
      </h2>
