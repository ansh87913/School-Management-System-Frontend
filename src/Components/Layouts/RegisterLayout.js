...
const RegisterLayout = () => {
  ...
  return (
    <main
      id="register"
      className="relative z-0 flex h-screen items-center justify-center bg-gradient-to-b from-slate-400 to-slate-300 py-8 text-slate-900 dark:from-slate-800 dark:to-slate-950 dark:text-slate-200 font-mono"
    >
      <section className="my-8 flex h-fit w-fit animate-fadeInFast flex-col justify-start gap-6 rounded-md bg-slate-100 p-4 text-slate-900 opacity-90 hover:opacity-100 focus:opacity-100 dark:bg-[#060913] dark:text-slate-50 md:p-8 lg:flex-row xl:w-1/2 ">
        <div className="flex flex-col-reverse justify-between lg:flex-col ">
          ...
          <div className="m-2 flex flex-col-reverse gap-4 text-4xl md:text-5xl  lg:flex-col ">
            ...
            <Link
              className="flex items-center font-mono text-xl font-semibold text-slate-900 dark:text-slate-50"
              to="../"
            >
              <FaGraduationCap />
